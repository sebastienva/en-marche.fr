...
class AdherentRepositoryTest extends MysqlWebTestCase
{
    ...
    public function testFindReferentByCommittee()
    {
        ...
        $committee = $this->getMockBuilder(Committee::class)->disableOriginalConstructor()->getMock();
        ...
        // Parisian district Commitee with Referent
        $committee = $this->getMockBuilder(Committee::class)->disableOriginalConstructor()->getMock();
        $committee->expects(static::any())->method('getCountry')->willReturn('FR');
        $committee->expects(static::any())->method('getPostalCode')->willReturn('75008');
        ...
        // Corsica Committee with Referent
        $committee = $this->getMockBuilder(Committee::class)->disableOriginalConstructor()->getMock();
        $committee->expects(static::any())->method('getCountry')->willReturn('FR');
        $committee->expects(static::any())->method('getPostalCode')->willReturn('20200');
